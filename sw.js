const CACHE="music-theory-pink-pixel-ui-v10";
const ASSETS=["./","./index.html","./db.js","./app.js","./manifest.webmanifest","./icon-180.png","./hana-menu-sprites.png","./hana-menu-dizzy.png"];
